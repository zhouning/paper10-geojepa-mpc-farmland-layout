...
Record 1 contains the public code/evidence package: code, tests, scripts, smoke data, generated non-DLTB JSON/Markdown/CSV/NPZ outputs, source-data tables, checkpoints, model-weight artifacts, metadata, and reproducibility documentation. Code and scripts are Apache-2.0. Generated non-DLTB artifacts are CC0-1.0.
...
- Interoperable: source-data files use tracked CSV, JSON, Markdown and NPZ package formats, with figure/table mappings recorded.
...
|---|---|
| Main Figure 1 | workflow schematic source map recorded; final artwork pending_artwork |
...
The final export package and source-coverage audit remain the controlling files for figure/table rendering. This closeout does not convert ignored local preview files into submission assets.

## Unresolved submission fields

- Main Figure 1 final artwork: pending_artwork.
