...
```powershell
D:\adk\.venv\Scripts\python.exe -m paper10_geojepa_mpc.experiments.run_e0_env_rollout_smoke --checkpoint paper10_geojepa_mpc\experiments\checkpoints\e0_frontier_random050_value_head_20x16_h5_seed44_top5\value_head_seed3044.pt --prepared-dir D:\test --rollout-steps 5 --horizon 5 --top-k 50 --seed 0 --device cpu --mask-mode executable --selector value_filter --candidate-score-mode blend --candidate-value-weight 0.1 --output reviewer_outputs\paper10_real_env_value_filter_smoke_5step_h5_k50_seed0.json
```

Raw local output: `reviewer_outputs\paper10_real_env_value_filter_smoke_5step_h5_k50_seed0.json`
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 1 | 1434 | 0.6850 | 2316 | 50 | 3 | -0.016592 | 0.000153 | 0.000000 | 0.0548 |
| 2 | 2580 | 0.5801 | 2315 | 50 | 3 | -0.030031 | 0.000458 | 0.000000 | 0.0614 |
| 3 | 2414 | 1.2983 | 2314 | 50 | 2 | -0.063729 | 0.000102 | 0.000000 | 0.0675 |
| 4 | 2197 | 0.4960 | 2313 | 50 | 5 | -0.075420 | 0.000305 | 0.000000 | 0.0641 |
| 5 | 2379 | -0.6340 | 2312 | 50 | 5 | -0.103306 | 0.000763 | -24.969708 | 0.0672 |
