...
Expected: complete round 1 and round 2 manifests for all model seeds; no round 3; calibrator/label/checkpoint lineage matches.

- [ ] **Step 3: Run bounded development and required ablations**
...
- [ ] **Step 4: Write and inspect the freeze audit**
...
- [ ] **Step 5: Commit the freeze before confirmation**
...
- [ ] **Step 6: Verify the committed frozen blob from a fresh process**
