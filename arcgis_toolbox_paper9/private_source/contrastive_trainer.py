"""Vendored ContrastiveTransitionTrainer (Paper 9 v6 trainer).

Source: D:/test/paper9_contrastive/contrastive_trainer.py.
Stripped of the adk import (uses our local core.transition_model).
